 ...
 const address = sessionStorage.getItem("walletAddress")
    const checkoutHandler = async (amount) => {
        ...
        const { data: { order } } = await axios.post("http://localhost:4000/api/checkout", {
            amount:amount, walletAddress: address
        })
        ...
        const options = {
            ...
            description: "VIT Token",
            image: "https://avatars.githubusercontent.com/u/63440566?v=4",
            order_id: order.id,
    ...
    <div class="flex min- overflow-hidden">
        <div class="flex flex-col justify-center flex-1 px-4 py-12 sm:px-6  lg:px-20 xl:px-24">
            <div class="w-full max-w-xl mx-auto lg:w-96">
                <div>
                    <a href="./index.html" class="text-blue-600 text-medium">Current Balance: {balance}</a>
                    <h2 class="mt-6 text-3xl font-extrabold text-neutral-600">Add Balance</h2>
                </div>
